...
public class CheckpointNetwork : MonoBehaviour
{
    ...
    public void Build()
    {
        ...
        // Auto-configure RaceCheckpoint components
        for (int i = 0; i < _checkpoints.Count; i++)
        {
            ...
            // Assign the correct index (checking for one-based setting if needed, but usually tracker uses 0-based internally or matches this)
            // NetworkedCheckpointTracker expects 0-based or matching index. Let's send the internal raw 0-based index for consistency.
            // If CheckpointNetwork uses one-based for GetCheckpoint(1), that's fine, but internal lists are 0-based.
            // Let's stick to 0-based for the tracker logic to match list indices.
