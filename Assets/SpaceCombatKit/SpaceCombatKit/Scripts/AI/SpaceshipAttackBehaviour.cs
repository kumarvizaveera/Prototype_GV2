...
namespace VSX.SpaceCombatKit
{
    public class SpaceshipAttackBehaviour : AISpaceshipBehaviour
    {
        ...
        public override bool BehaviourUpdate()
        {
            ...
            Vector3 velocity = weapons.WeaponsTargetSelector.SelectedTarget.Rigidbody == null ? Vector3.zero : weapons.WeaponsTargetSelector.SelectedTarget.Rigidbody.linearVelocity;
