    ...
    public class RigidbodyCharacterAnimations : MonoBehaviour
    {
        ...
        protected void Update()
        {
            ...
            if (animationsEnabled)
            {
                ...
                Vector3 forwardVelocity = Vector3.Dot(m_RigidbodyCharacterController.Rigidbody.linearVelocity, m_RigidbodyCharacterController.Rigidbody.transform.forward) * m_RigidbodyCharacterController.Rigidbody.transform.forward;
