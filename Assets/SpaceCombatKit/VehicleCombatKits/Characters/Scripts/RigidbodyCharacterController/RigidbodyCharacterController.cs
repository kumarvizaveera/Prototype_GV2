    ...
    public class RigidbodyCharacterController : MonoBehaviour
    {
        ...
        protected virtual void SetGrounded(bool grounded)
        {
            ...
            if (grounded)
            {
                ...
                if (!this.grounded)
                {
                    onGrounded.Invoke(m_Rigidbody.linearVelocity);
                }
                
                this.grounded = true;
                jetpacking = false;
                m_Rigidbody.useGravity = false;
                m_Rigidbody.linearDamping = groundedDrag;
                velocity.y = 0;
            }
            // Become airborne
            else
            {
                ...
                m_Rigidbody.linearDamping = airborneDrag;
            }
        }
        ...
        protected virtual void GroundedMovement()
        {
            ...
            if (!m_Rigidbody.isKinematic) m_Rigidbody.linearVelocity = velocity;
