...
namespace VSX.VehicleCombatKits
{
    ...
    public class HUDTargetInfo : MonoBehaviour, IRootTransformUser
    {
        ...
        [SerializeField]
        protected TextController targetLabelText;

        [Tooltip("The text displaying the target faction.")]
        [SerializeField]
        protected TextController targetFactionText;

        [Tooltip("The text displaying the distance to the target.")]
        [SerializeField]
        protected TextController distanceText;
        ...
        public class HealthDisplay
        {
            ...
            public TextController healthRemainingText;
        ...
        protected virtual void UpdateSpeedText()
        {
            if (speedText != null)
            {
                if (target.Rigidbody != null)
                {
                    ...
                    speedText.text = Mathf.RoundToInt(target.Rigidbody.linearVelocity.magnitude).ToString() + " M/S";
                }
                else
                {
