...
namespace VSX.Characters
{
    ...
    public class PlayerInput_Base_CharacterInteractionControls : VehicleInput
    {
        ...
        [Tooltip("After an interaction occurs, how long before it can happen again. Prevents bugs with multiple interactions in the same frame.")]
        [SerializeField]
        protected float minInteractionInterval = 0.5f;
        ...
        [SerializeField]
        protected TextController promptText;
        ...
        protected virtual void Interact()
        {
            ...
            if (vehicle == gameAgent.Character)
            {
                if (gameAgent.Character.Interactable != null)
                {
                    ...
                    PauseInteractions(minInteractionInterval);
                }
            }
        }
