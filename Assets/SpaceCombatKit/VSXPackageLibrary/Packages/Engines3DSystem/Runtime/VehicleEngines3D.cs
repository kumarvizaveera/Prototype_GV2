...
namespace VSX.Engines3D
{
    ...
    public class VehicleEngines3D : Engines
    {
        ...
        {
            return (force / rBody.linearDamping - force * Time.fixedDeltaTime) / rBody.mass; // Subtracting (force * Time.fixedDeltaTime) / rBody.mass because drag is applied AFTER force is added
        }
        ...
        {
            return speed / ((1 / rBody.linearDamping - Time.fixedDeltaTime) / rBody.mass);
        }
        ...
        public static float GetAngularSpeedFromTorque(float torque, Rigidbody rBody)
        {
            ...
            return Mathf.Clamp(torque / Mathf.Max(rBody.angularDamping, 0.0001f) - torque * Time.fixedDeltaTime, -rBody.maxAngularVelocity, rBody.maxAngularVelocity);
        }
        ...
        {
            return angularSpeed / ((1 / Mathf.Max(rBody.angularDamping, 1) - Time.fixedDeltaTime));
        }
        ...
        {
            SetMovementInputs(new Vector3((speed * m_rigidbody.mass * m_rigidbody.linearDamping) / maxMovementForces.x, movementInputs.y, movementInputs.z));
        }
        ...
        {
            SetMovementInputs(new Vector3(movementInputs.x, (speed * m_rigidbody.mass * m_rigidbody.linearDamping) / maxMovementForces.y, movementInputs.z));
        }
        ...
        {
            SetMovementInputs(new Vector3(movementInputs.x, movementInputs.y, (speed * m_rigidbody.mass * m_rigidbody.linearDamping) / maxMovementForces.z));
        }
        ...
        protected virtual void FixedUpdate()
        {
            ...
            if (enginesActivated)
            {
                ...
                else
                {
                    ...
                    {
                        float topSpeedAmount = Mathf.Clamp(Mathf.Abs(m_rigidbody.linearVelocity.magnitude / topSpeed), 0, 1);
