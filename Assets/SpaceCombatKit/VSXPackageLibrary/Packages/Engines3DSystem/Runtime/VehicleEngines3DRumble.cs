...
namespace VSX.Engines3D
{
    ...
    public class VehicleEngines3DRumble : MonoBehaviour
    {
        ...
        protected virtual void VelocityRumblesUpdate()
        {
            ...
            float velocityRumble = velocityRumbleCurve.Evaluate(Mathf.Clamp(rBody.linearVelocity.magnitude / maxVelocityThreshold, 0, 1)) * maxVelocityRumble;
        ...
        protected virtual void AccelerationRumblesUpdate()
        {
            ...
            float acceleration = (rBody.linearVelocity.magnitude - lastVelocity.magnitude) / Time.fixedDeltaTime;
