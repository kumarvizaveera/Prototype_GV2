...
namespace VSX.Weapons
{
    ...
    public class BeamSoundEffectsController : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            beamWeaponUnit.onBeamStarted.AddListener(OnBeamStarted);
            beamWeaponUnit.onBeamStopped.AddListener(OnBeamStopped);

            foreach(ModulatedAudio loopedAudio in beamLoopAudios)
            {
                loopedAudio.Initialize();
            }
