...
namespace VSX.Weapons
{
    ...
    public class WeaponsController : ModuleManager, ILeadTargetInfo
    {
        ...
        [Tooltip("Whether to use the target selected by the above Target Selector as the target that missile weapons lock onto.")]
        [SerializeField]
        protected bool useTargetSelectorForMissileLocking = true;
        public virtual bool UseTargetSelectorForMissileLocking
        {
            get => useTargetSelectorForMissileLocking;
            set => useTargetSelectorForMissileLocking = value;
        }
        ...
        protected virtual void AddWeapon(MissileWeapon missileWeapon)
        {
            if (!missileWeapons.Contains(missileWeapon))
            {
                ...
                if (useTargetSelectorForMissileLocking && weaponsTargetSelector != null) weaponsTargetSelector.onSelectedTargetChanged.AddListener(missileWeapon.TargetLocker.SetTarget);
            }
        }
        ...
        protected virtual void RemoveWeapon(MissileWeapon missileWeapon)
        {
            ...
            if (useTargetSelectorForMissileLocking && weaponsTargetSelector != null) weaponsTargetSelector.onSelectedTargetChanged.RemoveListener(missileWeapon.TargetLocker.SetTarget);
        }
