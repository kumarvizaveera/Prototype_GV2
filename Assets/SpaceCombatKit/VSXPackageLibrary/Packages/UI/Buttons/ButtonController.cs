...
namespace VSX.UI
{
    ...
    public class ButtonController : Button, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, IPointerClickHandler, ISubmitHandler
    {
        ...
        [SerializeField]
        protected List<TextController> texts = new List<TextController>();
        ...
        protected override void Reset()
        {
            ...
            texts = new List<TextController>(GetComponentsInChildren<TextController>());
        ...
        protected virtual void UpdateState()
        {
            ...
            if (priorityState != currentState)
            {
                ...
                highlightedState.IsPriorityState = priorityState == highlightedState;
                selectedState.IsPriorityState = priorityState == selectedState;
                deepSelectedState.IsPriorityState = priorityState == deepSelectedState;
            }
        }
